...
//   if (e.keyCode == "190" && !skipsToggled){ //Skips haven't been toggled yet
//     chrome.extension.sendMessage({
//       action: 'ToggleSkips'
//     });
//     skipsToggled = true; //Need to add this or any keypress will toggle skips
//   } else if (e.keyCode == "190" && skipsToggled) { //Skips have been toggled and shift is no longer being held down.
//     chrome.extension.sendMessage({
//       action: 'ToggleSkips'
//     });
//     skipsToggled = false;
